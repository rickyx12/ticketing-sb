				 			...
				 			editModal += "<div class='modal-body'>";
				 				editModal += "<div class='col-md-12'>";
				 					editModal += "<div class='form-group'>";
				 						...
				 						editModal += "<input type='text' id='edit-subject' class='form-control' autocomplete='off' value='"+field.subject+"'>";
				 					editModal += "</div>";
				 					editModal += "<div class='form-group'>";
				 						editModal += "<label>Code/Title</label>";
				 						editModal += "<input type='text' id='edit-title' class='form-control' autocomplete='off' value='"+field.code+"'>";
				 					editModal += "</div>";
				 				editModal += "</div>";
				 			editModal += "</div>";
				 		editModal += "</div>";
